...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : SRF05_TRIG_Pin */
  GPIO_InitStruct.Pin = SRF05_TRIG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SRF05_TRIG_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : HMC5883L_DRY_Pin */
  GPIO_InitStruct.Pin = HMC5883L_DRY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(HMC5883L_DRY_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : SX_RESET_Pin SX_NSS_Pin */
  GPIO_InitStruct.Pin = SX_RESET_Pin|SX_NSS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
//     HAL_TIM_ReadCapturedValue(&htim2, TIM_CHANNEL_4);
