...
void Logger_LogFlightData(const FlightLogData_t *log_data) {
    ...
    const int written = snprintf(buffer, sizeof(buffer),
             ...
             "\"roll_p\":%.4f,\"roll_i\":%.4f,\"roll_d\":%.4f,"
             "\"pitch_p\":%.4f,\"pitch_i\":%.4f,\"pitch_d\":%.4f,"
             ...
             (double)log_data->roll_p, (double)log_data->roll_i, (double)log_data->roll_d,
             (double)log_data->pitch_p, (double)log_data->pitch_i, (double)log_data->pitch_d,
